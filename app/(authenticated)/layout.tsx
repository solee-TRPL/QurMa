...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const getPageTitle = (page: PageView) => {
    switch (page) {
      ...
      case "dashboard-school":
        return "Dashboard: Data Sekolah";
      case "dashboard-memorization":
        return "Data Hafalan";
      ...
      case "data-kehadiran":
        return "Data Kehadiran";
      case "data-catatan":
        return "Catatan dan Pencapaian";
      case "input-hafalan":
        return "Input Hafalan Baru";
      case "recap-hafalan":
        return "Rekap Hafalan";
      case "exam-grades":
        return "Penilaian Ujian";
      case "reports":
        return "Laporan Hafalan";
      case "guardian-exams":
        return "Nilai Ujian";
      case "student-progress":
        return "Perkembangan Santri";
      case "pencapaian":
        return "Pencapaian Santri";
      case "teacher-notes":
        return "Catatan Untuk Santri";
      case "settings":
        return "Pengaturan";
      case "weekly-target":
        return "Input Target Pekanan";
      case "weekly-target-notes":
        return "Catatan Perkembangan Pekanan";
      case "sa-dashboard":
        return "Platform Dashboard";
      case "sa-tenants":
        return "Manajemen Sekolah";
      case "sa-users":
        return "Manajemen Pengguna Global";
      case "sa-audit-logs":
        return "Global Audit Logs";
      case "sa-platform-settings":
        return "Pengaturan Platform";
      case "sa-email-settings":
        return "Pengaturan Email";
      case "weekly-target-monitor":
        return "Monitor Target Pekanan";
      case "weekly-target-monitor-notes":
        return "Monitor Catatan Pekanan";
      case "monitor-hafalan":
        return "Monitor Hafalan Santri";
      case "monitor-hafalan-harian":
        return "Monitor Hafalan Harian";
      default:
        return "QurMa";
    }
  };
  ...
  const getPageSubtitle = (page: PageView) => {
    switch (page) {
      case "dashboard":
        return "Ringkasan data & statistik operasional tahfidz";
      case "dashboard-school":
        return "Ringkasan statistik santri, asatidz, dan halaqah";
      case "dashboard-memorization":
        return "Tren setoran dan capaian target hafalan";
      case "dashboard-attendance":
        return "Tren dan rekapitulasi kehadiran santri";
      case "users":
        return "Kelola akses administrator, guru, dan pengawas";
      case "student-management":
        return "Pengaturan halaqah, kelompok belajar, dan data santri";
      case "classes":
        return "Data Organisasi Kelas & Sub-Kelas";
      // case 'halaqah-management': return 'Pengaturan kelompok dan pembimbing halaqah';
      case "target-management":
        return "Standarisasi kurikulum dan target hafalan";
      case "audit-logs":
        return "Rekaman riwayat aktivitas sistem";
      case "data-santri":
        return "Database lengkap informasi santri";
      case "data-hafalan":
        return "Monitoring hafalan saat ini seluruh santri";
      case "data-kehadiran":
        return "Rekapitulasi status kehadiran dan setoran santri";
      case "data-catatan":
        return "Pencatatan evaluasi dan pencapaian santri";
      case "input-hafalan":
        return "Rekam kemajuan setoran harian santri secara real-time";
      case "recap-hafalan":
        return "Analisis data kolektif dan riwayat setoran per periode";
      case "exam-grades":
        return "Evaluasi kumulatif hasil ujian dan standar tasmi' santri";
      case "weekly-target":
        return "Atur rencana dan capaian hafalan untuk satu pekan ke depan";
      case "weekly-target-notes":
        return "Catatan khusus asatidz mengenai perkembangan santri per pekan";
      case "settings":
        return "Konfigurasi profil dan preferensi sekolah";
      case "sa-dashboard":
        return "Statistik agregat dan metrik pertumbuhan seluruh ekosistem platform";
      case "sa-tenants":
        return "Database pusat sekolah dan manajemen lisensi tenant";
      case "sa-users":
        return "Kelola kredensial dan hak akses seluruh akun di platform";
      case "sa-audit-logs":
        return "Log aktivitas global untuk pengecekan keamanan dan audit sistem";
      case "sa-platform-settings":
        return "Konfigurasi parameter sistem, branding, dan variabel global";
      case "sa-email-settings":
        return "Pengaturan server SMTP dan template notifikasi email sistem";
      case "reports":
        return "Riwayat lengkap setoran hafalan harian dan kualitas bacaan";
      case "student-progress":
        return "Visualisasi grafik perkembangan dan pencapaian target hafalan";
      case "guardian-exams":
        return "Rekapitulasi hasil ujian kumulatif dan standar penilaian asatidz";
      case "weekly-target-monitor":
        return "Pantau rencana dan pencapaian target hafalan seluruh ustadz";
      case "weekly-target-monitor-notes":
        return "Pantau catatan ustadz mengenai perkembangan santri per pekan";
      case "monitor-hafalan":
        return "Pantau progres dan kualitas setoran hafalan santri secara menyeluruh";
      case "monitor-hafalan-harian":
        return "Pantau setoran hafalan harian santri per halaqoh";
      case "pencapaian":
        return "Daftar penghargaan dan apresiasi atas kedisiplinan menghafal";
      case "teacher-notes":
        return "Kumpulan pesan motivasi dan evaluasi dari ustadz pembimbing";
      default:
        return undefined;
    }
  };
      ...
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 overflow-hidden relative">
        ...
        <div className="flex flex-col items-center justify-center animate-in fade-in zoom-in-95 duration-700 relative z-10">
          ...
          <div className="flex flex-col items-center space-y-2">
            <h2 className="text-[14px] font-black text-slate-800 uppercase tracking-[0.4em] leading-none">{platformName} Platform</h2>
    ...
    >
      ...
      {showUnsavedModal && (
        <div className="fixed top-16 right-0 bottom-0 left-0 lg:left-64 z-[999] flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-slate-900/60 backdrop-blur-md animate-in fade-in duration-200" onClick={() => setShowUnsavedModal(false)} />
          <div className="relative bg-white rounded-xl shadow-none w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-200 border-2 border-slate-300 flex flex-col" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="px-5 py-3 border-b border-slate-100 flex justify-between items-center bg-white shrink-0">
              ...
              <button onClick={() => setShowUnsavedModal(false)} className="p-1.5 hover:bg-slate-50 rounded-full transition-colors">
