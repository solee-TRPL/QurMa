...
export default function WeeklyTargetNotesPage() {
  ...
  return <WeeklyTarget user={user} tenantId={user.tenant_id!} onSetUnsavedChanges={setHasUnsavedChanges} showNotesMode={true} saveTrigger={saveTriggered} onSaveSuccess={proceedNavigation} isGlobalModalOpen={showUnsavedModal} />;
}
