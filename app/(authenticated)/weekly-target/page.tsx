...
export default function WeeklyTargetPage() {
  ...
  return <WeeklyTarget user={user} tenantId={user.tenant_id || ""} onSetUnsavedChanges={setHasUnsavedChanges} saveTrigger={saveTriggered} onSaveSuccess={proceedNavigation} isGlobalModalOpen={showUnsavedModal} />;
}
