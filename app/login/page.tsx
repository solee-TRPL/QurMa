...
export default function LoginPage() {
  ...
  const handleAuth = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // handleAuthSuccess in providers/context will handle redirection
    } catch (error: any) {
  ...
  return (
    <div className="h-screen w-screen bg-white flex overflow-hidden font-sans">
      <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-jade-600 to-jade-800 relative items-center justify-center p-20 overflow-hidden border-r-4 border-black/5">
        ...
        <div className="relative z-20 w-full max-w-md animate-in slide-in-from-left duration-700">
          <div className="text-left">
            ...
            <h2 className="text-2xl font-black text-white uppercase tracking-tight leading-none mb-3">Sistem Tahfidz Terpadu</h2>
            <p className="text-[10px] font-black text-primary-500 uppercase tracking-[0.2em] opacity-90 mb-6">Monitoring & Penilaian Real-time</p>
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-8 mb-12">
              {[
                ...
                <div key={item.title} className="group">
                  ...
                  <p className="text-[8px] font-bold text-white/40 uppercase tracking-wide leading-tight group-hover:text-white/60 transition-colors">{item.desc}</p>
                </div>
              ))}
            </div>
            ...
            <div className="border-t border-white/10 pt-8 flex gap-4">
              {[
                ...
                <div key={stat.lab}>
                  ...
                  <p className="text-[8px] font-black text-[#a5d1bd] uppercase tracking-widest">{stat.lab}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="flex-1 lg:w-1/2 flex items-center justify-center p-6 lg:p-8 bg-white relative overflow-hidden">
        ...
        <div className="w-full max-w-85 p-2 relative z-10 transform animate-in fade-in slide-in-from-bottom-4 duration-700 mt-8 lg:mt-0">
          <div className="text-center mb-8 relative z-10 flex flex-col items-center justify-center">
            {isSignUp ? (
              <>
                <h1 className="text-2xl font-black text-slate-900 uppercase tracking-tight leading-none">Daftar Superadmin</h1>
                <p className="text-[10px] font-black text-jade-600 uppercase tracking-[0.2em] mt-3 opacity-80">Inisialisasi Platform Pertama</p>
              </>
            ) : (
              <img src="/images/qurma-logo.png" alt="QurMa" className="h-40 w-auto object-contain" />
            )}
          </div>

          <div className="space-y-5 relative z-10">
            <form ref={formRef} onSubmit={handleAuth} className="space-y-4" noValidate autoComplete="off">
              {isSignUp && (
                <div className="group">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-white border-2 border-slate-400 rounded-xl text-slate-800 font-bold text-xs focus:border-jade-400 focus:ring-4 focus:ring-jade-50/50 outline-none transition-all placeholder:text-slate-300 shadow-none"
                    />
                  </div>
                </div>
              )}
              ...
              <div className="group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-3 bg-white border-2 border-slate-400 rounded-xl text-slate-800 font-bold text-xs focus:border-jade-400 focus:ring-4 focus:ring-jade-50/50 outline-none transition-all placeholder:text-slate-300 shadow-none"
                  />
                  <button
                    type="button"
                  ...
                  >
                    {showPassword ? <EyeOff className="h-4 w-4 text-slate-400 group-focus-within:text-jade-600 transition-colors" /> : <Eye className="h-4 w-4 text-slate-400 group-focus-within:text-jade-600 transition-colors" />}
                  </button>
                </div>
              </div>
            ...
            <div className="text-center pt-2">
              <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest leading-relaxed">
                {isSignUp ? "Pendaftar pertama akan otomatis menjadi Superadmin platform" : "Silakan hubungi administrator sekolah untuk mendapatkan kredensial akses"}
              </p>
            </div>
          </div>
        </div>
