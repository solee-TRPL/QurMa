...
export const Dashboard: React.FC<DashboardProps> = ({ user, onNavigate, currentPage = "dashboard" }) => {
  ...
  if (user.role === UserRole.ADMIN || user.role === UserRole.SUPERVISOR) {
    return (
      <AdminDashboardProvider user={user} adminStats={adminStats} halaqahs={halaqahs} allUsers={allUsers} students={students} activeDays={activeDays} isRefreshing={isRefreshing} refreshData={refreshData}>
