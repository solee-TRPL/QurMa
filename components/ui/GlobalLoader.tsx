...
export const GlobalLoader: React.FC = () => {
  return (
    <div className="fixed inset-0 z-999999 flex items-center justify-center bg-white/95 backdrop-blur-sm animate-in fade-in duration-500">
      <div className="flex flex-col items-center justify-center max-75 w-full">
        ...
        <div className="relative w-28 h-28 flex items-center justify-center mb-10">
          ...
          <div className="relative w-16 h-16 bg-white border border-slate-100 rounded-3xl flex items-center justify-center shadow-xl shadow-jade-900/5 ring-4 ring-jade-50/30">
        ...
        <div className="flex flex-col items-center w-full">
          <h1 className="text-[13px] font-black text-slate-800 uppercase tracking-[0.5em] leading-none mb-3 text-center">QURMA PLATFORM</h1>
          <div className="flex items-center gap-4 w-full px-4">
            <div className="h-px bg-linear-to-r from-transparent to-slate-200 flex-1"></div>
            <span className="text-[9px] font-black text-jade-500 uppercase tracking-[0.3em] whitespace-nowrap">MEMUAT DATA</span>
