...
import { MessageSquare, X, Calendar, User, Reply, Send, MessageCircle, CheckCircle2, ChevronDown, Pencil, Trash2, Check } from "lucide-react";
              ...
              notes.map((note) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`grid transition-all duration-500 ease-in-out ${isExpanded && replyingTo !== note.id ? "grid-rows-[1fr] opacity-100 mt-2" : "grid-rows-[0fr] opacity-0"}`}>
                    ...
                    <div className={`grid transition-all duration-300 ease-in-out ${replyingTo === note.id ? "grid-rows-[1fr] opacity-100 mt-2" : "grid-rows-[0fr] opacity-0"}`}>
                      <div className="overflow-hidden">
                        <div className="w-full flex items-center bg-white border-2 border-slate-200 rounded-xl pl-4 pr-1.5 py-1 focus-within:border-jade-400 focus-within:ring-4 focus-within:ring-jade-50 transition-all hover:border-slate-300" onClick={(e) => e.stopPropagation()}>
                          <input
                            type="text"
                            value={replyContent}
                          ...
                          <div className="flex items-center gap-1 shrink-0 ml-2">
                            ...
                            <button
                              ...
                              title={note.reply_content ? "Update" : "Simpan"}
