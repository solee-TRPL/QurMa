                        ...
                        <div className="space-y-3">
                            {(() => {
                                ...
                                return Object.values(grouped).map(group => {
                                    ...
                                    const hasTidakSetor = group.records.some(r => r.status === MemorizationStatus.TIDAK_SETOR || (String(r.status || r.keterangan || '').toUpperCase().includes('TIDAK')));
                                    ...
                                    return (
                                        <div key={`${group.student_id}_${group.date}`} className="bg-white p-3.5 rounded-xl border-2 border-slate-200 group hover:border-slate-300 transition-all shadow-none">
                                            <div className="flex justify-between items-start mb-3">
                                                ...
                                                <span className="text-[8px] font-black text-slate-400 uppercase tracking-[0.1em]">{group.date}</span>
                                            </div>
