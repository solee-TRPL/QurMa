                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-1.5">
                      <div className="flex items-center gap-1 text-slate-400">
                        ...
                        <span className="text-[7.5px] font-black uppercase tracking-widest leading-none">{new Date(item.date).toLocaleDateString("id-ID", { day: "numeric", month: "short", year: "numeric" }).toUpperCase()}</span>
                      </div>
                    </div>
                  </div>
                </div>
