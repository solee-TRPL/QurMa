                                ...
                                <div key={exam.id} className="p-3.5 bg-white border-2 border-slate-200 rounded-xl flex items-center justify-between group hover:border-slate-300 transition-all">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[7.5px] font-black text-slate-400 mt-1 uppercase tracking-widest leading-none">{exam.location} • {exam.time}</p>
                                        </div>
                                    </div>
                                    <span className={`px-2 py-1 rounded-lg text-[7px] font-black uppercase tracking-widest border-2 ${
